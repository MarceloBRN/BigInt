...
int main() {
	...
	bnum::BigInt bint1(BIGINT(-3000006536563535635765765855356365365980435765765854843653656353563576576585484));
	...
	bnum::BigInt bint2(BIGINT(65765854843653656353563576536563535636585658548435765765854843653656353563576576585484));
	...
	std::string s21("-0");
	bnum::BigInt bint21(s21);
	if (bint21.to_string() != "0") {
		std::cout << "(WRONG)";
	}
	std::cout << "constructor23: " << bint21 << std::endl;

	bnum::BigInt bint22(10);
	std::cin >> bint22;
	std::cout << "constructor24: " << bint22 << std::endl;
